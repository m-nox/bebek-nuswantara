  ...
  return (
    <div className="container" style={{ padding: '60px 20px' }}>
      <div className="text-center mb-12">
        ...
        <p className="text-muted text-lg" style={{ maxWidth: 600, margin: '0 auto' }}>
          Kunjungi kedai kami untuk menikmati sajian Bebek Nuswantara secara langsung, atau hubungi kami untuk layanan pelanggan.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-8" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))' }}>
        ...
        <div className="card flex flex-col gap-6">
          ...
          <div className="flex gap-4 items-start">
            <div className="btn-icon" style={{ backgroundColor: 'var(--primary-light)', color: 'var(--primary)', border: 'none', flexShrink: 0 }}>
              <MapPin />
            </div>
            <div>
